...
plot_c1 = np.zeros((num_experiments, num_repeats))
...
for j in range(num_experiments):
    ...
    for i in range(num_repeats):
        ...
        print()
        print(f'CIID1: Finished repeat {i+1}/{num_repeats} of experiment {percentages[j]}.')
        print()


np.save('StyleGAN2_cat_psi=0.5_inception_sample_8000_reps_10_c1.npy', np.array(plot_c1))
np.save('StyleGAN2_cat_psi=0.5_inception_sample_8000_reps_10_c1_times_fun.npy', np.array(times_fun))

print('Saved results of StyleGAN2_cat_psi=0.5_inception_sample_8000_reps_10_CIID1.')